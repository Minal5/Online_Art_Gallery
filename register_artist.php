...
if(isset($_POST['name'])){
    ...
    // Check if username is empty
        ...
        if(trim($_POST['password']) !=  trim($_POST['cpassword'])){
            ...
            $sql = "SELECT username FROM artist WHERE username = '$username'";
            ...
            else 
            {
                ...
                $sql = "INSERT INTO `art`.`artist` (`name`, `email`, `phone`, `address`, `username`, `password`) VALUES ('$name', '$email', '$phone', '$address', '$username', '$password');";
                $stmt = mysqli_query($con, $sql);
                    if($stmt)
                    {   
...
<body>
    <div class="container">
        ...
        <form action="register_artist.php" method="post">
